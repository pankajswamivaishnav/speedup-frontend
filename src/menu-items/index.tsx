...
export const transporterMenuItems: { items: NavItemType[] } = {
  items: [dashboard, managedTransporters, managedDrivers, managedVendors, bilty, loads, transportCards, driverCards, vendorCards, pricing]
};
...
export const vendorMenuItems: { items: NavItemType[] } = {
  items: [dashboard, managedTransporters, managedDrivers, managedVendors, loads, transportCards, pricing]
};
