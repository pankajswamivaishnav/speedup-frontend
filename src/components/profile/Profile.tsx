                ...
                <Grid item xs={12}>
                  ...
                  <Stack spacing={2.5} alignItems="center">
                    ...
                    <Stack spacing={0.5} alignItems="center">
                      ...
                      <Typography color="secondary">{`${profileData?.transporter_first_name} ${profileData?.transporter_last_name}`}</Typography>
                    </Stack>
                  </Stack>
                </Grid>
                <Grid item xs={12}>
            ...
            <MainCard title="About me">
              <Typography color="secondary">
                ...
                <strong className="text-black">
                  {profileData?.transporter_first_name} {profileData?.transporter_last_name}
                </strong>{' '}
                and <strong className="text-black">{profileData?.transportName}</strong> is one of the oldest and most trusted names in the
                Indian transport industry. As a professional transport broker, we connect businesses with reliable trucks and carriers
                across India.
                <br />
                From vegetables and household items to industrial and government goods, we ensure safe, timely, and cost-effective delivery.
                With decades of experience and a strong network, our focus remains on transparency, reliability, and building trust with
                every client.
              </Typography>
            </MainCard>
          </Grid>
                  ...
                  <Grid container spacing={3}>
                    <Grid item xs={12} md={6}>
                      <Stack spacing={0.5}>
                        ...
                        <Typography>{`${profileData?.transporter_first_name} ${profileData?.transporter_last_name}`}</Typography>
                      </Stack>
                    </Grid>
                    <Grid item xs={12} md={6}>
                      <Stack spacing={0.5}>
